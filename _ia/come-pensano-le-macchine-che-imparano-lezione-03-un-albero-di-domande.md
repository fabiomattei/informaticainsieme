...
Conosci di sicuro il meccanismo di "Indovina chi?": si tratta di un gioco da tavola e lo scopo del gioco è trovare una persona particolare in un gruppo di persone. A tal fine il giocatore può fare delle domande: "porta gli occhiali?", "ha i capelli scuri?". Ogni domanda permette al giocatore di avvicinarsi ad indovinare il personaggio permettendogli di scartare, in una situazione ideale, circa la metà dell'insieme delle persone. Poche domande, ben scelte, permettono al giocatore di arravare alla soluzione in modo molto più veloce che non provando ad indovinare a caso.
