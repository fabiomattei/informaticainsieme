...
| IdCliente | NomeCliente | NomeContatto | Nazione |
|---|---|---|---|
...
Il risultato dell’istruzione è quello di collegare tra loro le tuple corrispondenti e visualizzare insieme i dati provenienti da una o più tabelle.
